...
print([[
   ...
   .  yk_yy.   yk_yy    888       d  yk_yy8888  yk_yy.  
    yk_yy    yk_yy  yk_yy   888      d  yk_yy8888   Y88b 
  Y88b.     88  yk_yy  888       yk_y  yk_yy8    888 
   "Y  yk_yy.    yk_yy886 888      yk_yy   yk_yy88     yk_yy 
      "Y88b.888   yk_yy88     yk_yy    yk_yy"  
        "  yk_yy88    yk_yy    yk_yy     yk_yy88        
  Y88b    yk_yy888   Y8888 d  yk_yy88  yk_yy888        
   "  yk_yy88" 888    Y888  yk_yy       yk_yy88        
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SNAP-TEAM/Files_Snap/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1525163287,1370341056,1783964439}   
...
os.execute('wget https://raw.githubusercontent.com/SNAP-TEAM/SNAP/main/SNAP.lua')
...
Text = "ᴡᴇʟᴄᴏᴍᴇ sɴᴀᴘ sᴏᴜʀᴄᴇ ✷\n\n[𝘾𝙝𝙖𝙣𝙣𝙚𝙡 𝙎𝙣𝙖𝙥 💥](http://t.me/iinzzz)\n\n[𝙄𝙣𝙁𝙤 𝙎𝙤𝙪𝙧𝙘𝙚](http://t.me/BBI9B)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مطور سناب 🇮🇶 .',url="https://t.me/yk_yy"}},
}
local msg_id = msg.id_/2097152/0.5
...
if Devmode(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SNAP-TEAM/Files_Snap/main/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SNAP-TEAM/Files_Snap/main/File_Bot/"..file)
if res == 200 then
...
local UserName = (b.username_ or "SNAP-TEAM")
...
if text then   
local tyk_yyt = database:get(bot_id.."SNAP1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tyk_yyt == "rep" then   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- 𝚂𝙽𝙰𝙿 ᴛᴇᴀᴍ .',url="t.me/iinzzz"}},
}
local msg_id = msg.id_/2097152/0.5
...
*『3』◂ اوامر ضع ~ اضف  .*
*『4』◂ اوامر مسح ~ حذف .*
*『5』◂ اوامر تنزيل+رفع+التغير .*
*『6』◂ اوامر الكروب .*
*『7』◂ اوامر التحشيش .*
*『8』◂ اوامر مطور البوت .*
*『9』◂ اوامر مطور الاساسي .*
*『𝟏𝟎』◂ اوامر الاعضاء .*
*⋆ ┉  ┉  ┉  ┉ ┉  ┉  ┉  ┉ ⋆*
...
{
{text = '『9』', callback_data="/help9"},{text = '『𝟏𝟎』', callback_data="/help10"},
},
{
{text = '- 𝚂𝙽𝙰𝙿 ᴛᴇᴀᴍ .', url="t.me/iinzzz"},
},
...
if text ==  ""..Name_Bot..' شنو رائيك بهذا' and tonumber(msg.reply_to_message_id_) > 0 then     
...
if text == ""..Name_Bot..' تحب هاذ' and tonumber(msg.reply_to_message_id_) > 0 then    
function FunBot(extra, result, success) 
